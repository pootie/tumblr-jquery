	...
	$(document).ready(function() {	
			...
			$.tumblr = {};
			// modify these
			$.tumblr.url = "http://demo.tumblr.com/api/read/json?callback=?";
  ...
  function reloadTumblr(){  	
  	$("#tumblrFeed").empty();
  	$("#tumblrFeed").append("<div class='body'>loading Tumblr <img class='icon' src='" + $.tumblr.imagePath + "small_red.gif'/></div>");
    ...
    {		    	
    	case "regular":
    	{
				$("#tumblrFeed").append(
					...
					"<img class='icon' src='" + $.tumblr.imagePath + "regular.gif'/></a></td><td><div class='date'>" + dateFmt + "</div></td></table>");						
    	...
    	case "link":
    	{
				$("#tumblrFeed").append(
					"<table style='width: 100%;'><tr><td width='18px'>" +
					"<a href='" + post.url + "' target='_blank'>" +
					"<img class='icon' src='" + $.tumblr.imagePath + "link.gif'/></a></td><td><div class='date'>" + dateFmt + "</div></td></table>");						
    	...
    	case "quote":
    	{
				$("#tumblrFeed").append(
					"<table style='width: 100%;'><tr><td width='18px'>" +
					"<a href='" + post.url + "' target='_blank'>" +
					"<img class='icon' src='" + $.tumblr.imagePath + "quote.gif'/></a></td><td><div class='date'>" + dateFmt + "</div></td></table>");						
    	...
    	case "photo":
    	{
				$("#tumblrFeed").append(
					"<table style='width: 100%;'><tr><td width='18px'>" +
					"<a href='" + post.url + "' target='_blank'>" +
					"<img class='icon' src='" + $.tumblr.imagePath + "photo.gif'/></a></td><td><div class='date'>" + dateFmt + "</div></td></table>");						
    	...
    	case "conversation":
    	{
				$("#tumblrFeed").append(
					"<table style='width: 100%;'><tr><td width='18px'>" +
					"<a href='" + post.url + "' target='_blank'>" +
					"<img class='icon' src='" + $.tumblr.imagePath + "conversation.gif'/></a></td><td><div class='date'>" + dateFmt + "</div></td></table>");						
    	...
    	case "audio":
    	{
				$("#tumblrFeed").append(
					"<table style='width: 100%;'><tr><td width='18px'>" +
					"<a href='" + post.url + "' target='_blank'>" +
					"<img class='icon' src='" + $.tumblr.imagePath + "audio.gif'/></a></td><td><div class='date'>" + dateFmt + "</div></td></table>");						
    	...
    	case "video":
    	{
				$("#tumblrFeed").append(
					"<table style='width: 100%;'><tr><td width='18px'>" +
					"<a href='" + post.url + "' target='_blank'>" +
					"<img class='icon' src='" + $.tumblr.imagePath + "video.gif'/></a></td><td><div class='date'>" + dateFmt + "</div></td></table>");						
